...
<div class="container bg-white">
  <div class=" mt-5">
    ...
    max-height:150px;"></td>
            ...
            <td>
              <a href="edit_energie.php?id=<?= $fournisseur->id ?>" class="btn btn-info">Edit</a>
              <a onclick="return confirm('Are you sure you want to delete this entry?')" href="delete_energie.php?id=<?= $fournisseur->id ?>" class='btn btn-danger'>Delete</a>
            </td>
          </tr>
        <?php endforeach; ?>
      </table>
