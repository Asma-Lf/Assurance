...
?>
<?php require 'header_telecoms_internet.php'; ?>
<div class="container bg-white">
  <div class=" mt-5">
    ...
    max-width:250px;"></td>
            ...
            <td>
              <a href="edit_telecoms_internet.php?id=<?= $fournisseur->id ?>" class="btn btn-info">Edit</a>
              <a onclick="return confirm('Are you sure you want to delete this entry?')" href="delete_telecoms_internet.php?id=<?= $fournisseur->id ?>" class='btn btn-danger'>Delete</a>
            </td>
          </tr>
        <?php endforeach; ?>
      </table>
