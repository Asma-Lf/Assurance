        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-12 text-center text-lg-center">
                    ...
                    <h2 class="display-9 text-white ">Choisissez La Meilleure Box Internet Au Meilleur Prix.
                    </h2>

                    <strong class=" text-white ">Contactez nos conseillers pour dénicher le meilleur<br>
                        abonnement box Internet au meilleur prix.</strong>
                </div>
            </div>
        </div>
    </div>
